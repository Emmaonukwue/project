...
<head>
    ...
    <title>Admin Load Class Teacher's Comments</title>
	<style type="text/css">
.auto-style1 {
	text-align: center;
}
...
<h1 class="auto-style1">Admin Load Class Teacher's Comments</h1>
<body bgcolor="green">
    ...
    <select id="std_name" name="std_name" class="auto-style2" style="width: 136px; height: 28px" required>
        ...
        <label for="teachercomment">Class teacher comment:</label><br>
        <input type="text-area" name="teachercomment" id="subcomment" placeholder="Type your subject comment here" /><br>
