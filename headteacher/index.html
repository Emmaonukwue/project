...
<title>Headteacher's Home Page</title>
<style>
    body {
...
<div class="container">
    <div>
        <h1>Welcome to <br>Pinefield Report Headteacher's Page</h1>
    ...
    <div class="">
        <h3> Load Comments </h3>
        <br>
        <a href="load_hcomment.php" class="button">Load Headteacher's Comment</a>   </div>
