...
<div>
	...
	<table class="auto-style2" style="width: 100%">
		...
		<tr>
		<td class="auto-style6">&nbsp;<?php echo $civname = "Civic Education"?></td>
			<td class="auto-style3">&nbsp;<?php echo $civCA1 = doTotal($row1[40], $row1[41])?></td>
			<td class="auto-style3">&nbsp;<?php echo $civtotal = $civCA1 ?></td>
			<td class="auto-style3">&nbsp;<?php $civpercent = doPercent($civtotal, 30); echo round($civpercent, 2); ?></td>
			<td class="auto-style3">&nbsp;<?php echo $civgrade = doGrade($civpercent);?></td>
			<td class="auto-style3">&nbsp;<?php echo $civremark = doGradeRemark($civgrade)?></td>
		</tr>
		<tr>

		<tr>
		<td class="auto-style6">&nbsp;<?php echo $frename = "French"?></td>
			<td class="auto-style3">&nbsp;<?php echo $freCA1 = doTotal($row1[46], $row1[47]);?></td>
			<td class="auto-style3">&nbsp;<?php echo $fretotal = $freCA1 ?></td>
			<td class="auto-style3">&nbsp;<?php $frepercent = doPercent($fretotal, 30); echo round($frepercent, 2); ?></td>
			<td class="auto-style3">&nbsp;<?php echo $fregrade = doGrade($frepercent);?></td>
			<td class="auto-style3">&nbsp;<?php echo $freremark = doGradeRemark($fregrade)?></td>
		</tr>
				<?php
		} else {?>
		    <tr>
